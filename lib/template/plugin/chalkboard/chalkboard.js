...
//console.log("toggleChalkboardButton")
		...
		button.className = "chalkboard-button btn-tools";
		...
		button.innerHTML = '<a href="#" onclick="RevealChalkboard.toggleChalkboard(); return false;"><i class="far fa-edit"></i></a>'
...
//console.log("toggleNotesButton")
		...
		button.innerHTML = '<a href="#" onclick="RevealChalkboard.toggleNotesCanvas(); return false;"><i class="fas fa-pencil-alt"></i></a>'
		document.querySelector(".reveal").appendChild( button );
	}
//alert("Buttons");
...
//console.log("resetSlide ");
	...
	if( window.Reveal ) Reveal.registerKeyboardShortcut( 'C', 'Toggle pen on slide' );
	if( window.Reveal ) Reveal.registerKeyboardShortcut( 'B', 'Toggle whiteboard' );
	if( window.Reveal ) Reveal.registerKeyboardShortcut( 'X', 'Cycle pen colors forward' );
	if( window.Reveal ) Reveal.registerKeyboardShortcut( 'Y', 'Cycle pen colors backward' );
